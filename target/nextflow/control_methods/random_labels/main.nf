...
meta = [
  ...
  "description" : "A negative control, where the labels are randomly predicted based on the\nlabel distribution of the training data, without looking at the input data.\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_template/task_template/src/control_methods/random_labels/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_template/control_methods/random_labels",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
